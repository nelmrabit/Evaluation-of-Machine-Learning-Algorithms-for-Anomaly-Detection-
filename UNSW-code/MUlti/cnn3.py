...
cnn.add(Dropout(0.5))
cnn.add(Dense(10, activation="softmax")) # number of labels
...
cnn.fit(X_train, y_train, nb_epoch=20, validation_data=(X_test, y_test),callbacks=[checkpointer,csv_logger])
